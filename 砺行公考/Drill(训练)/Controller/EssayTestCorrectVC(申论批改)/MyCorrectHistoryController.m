...
@interface MyCorrectHistoryController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyCorrectHistoryController

- (void)getMyCorrectHistoryData {
    NSDictionary *parma = @{@"status_":@"4",
                            @"page_number":@"1",
                            @"page_size":@"50"
                            };
...
- (void)viewDidLoad {
    ...
    self.tableview.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        [weakSelf getMyCorrectHistoryData];
    }];
